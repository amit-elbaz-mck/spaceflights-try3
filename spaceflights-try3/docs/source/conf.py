...
# spaceflights_try3 documentation build
...
from spaceflights_try3 import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_try3"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_try3doc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_try3.tex",
        "spaceflights_try3 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_try3",
        "Project spaceflights_try3 codebase.",
        "Data-Science",
    )
]
